...
class SnowFlake {
    ...
    private final ChristmasRandom random;
    ...
    public static SnowFlake create(int width, int height, Paint paint) {
        ChristmasRandom random = new ChristmasRandom();
    ...
    SnowFlake(ChristmasRandom random, Point position, float angle, float increment, float flakeSize, Paint paint) {
        this.random = random;

...
public class OLD_DataListActivity extends AppCompatActivity{

    CardView rss_card , mecha_card , enabler_card , exp_card , star_card , troop_card;
    TextView rss_tv , mecha_tv , enabler_tv , exp_tv , star_tv , troop_tv;
    ...
    TextView food , fuel , steel , alloy , obsidian , kyanite , kyanite_basic , kyanite_cluster , glory_mark , catalyst ;
    ...
    int fuel_final , food_final , steel_final , alloy_final , obsidian_final , kyanite_final , kyanite_basic_final , kyanite_cluster_final , glory_mark_final , catalyst_final , diamond_final ;
    String star_final ;
    String mechaName , mechaLv , armyName , enablerName ;
    int armyFreeNum , armyMarchNum , enablerLv;

    String[] mechaNameArray = new String[4];
    String[] mechaLvArray = new String[4];

    String[] armyNameArray = new String[50];
    int[] armyFreeNumArray = new int[50];
    int[] armyMarchNumArray = new int[50];

    String[] enablerNameArray = new String[48];
    int[] enablerLvArray = new int[48];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(b!=null) { UID = (int) b.get("UID"); }
        Log.i("UID_DATA" , String.valueOf(UID));
    ...
    public void cbg() {
        ...
        if (theme.equals("custom")) {
            ...
            mecha_card	.setCardBackgroundColor(Color.parseColor("#CC"+color1));
            mecha_tv	.setBackgroundColor(Color.parseColor("#"+color2));
            enabler_card	.setCardBackgroundColor(Color.parseColor("#CC"+color1));
            enabler_tv	.setBackgroundColor(Color.parseColor("#"+color2));
            exp_card	.setCardBackgroundColor(Color.parseColor("#CC"+color1));
            exp_tv	.setBackgroundColor(Color.parseColor("#"+color2));
            star_card	.setCardBackgroundColor(Color.parseColor("#CC"+color1));
    ...
    public void dataRefresh (){
        ...
        String FOOD_S , FUEL_S , STEEL_S , ALLOY_S , OBSIDIAN_S , KYANITE_S , KYANITE_BASIC_S, KYANITE_CLUSTER_S , GLORY_MARK_S , CATALYST_S = null ;
        ...
        food.setText(FOOD_S);
        fuel.setText(FUEL_S);
        steel.setText(STEEL_S);
        alloy.setText(ALLOY_S);
        obsidian.setText(OBSIDIAN_S);
        kyanite.setText(KYANITE_S);
        kyanite_basic.setText(KYANITE_BASIC_S);
        kyanite_cluster.setText(KYANITE_CLUSTER_S);
        glory_mark.setText(GLORY_MARK_S);
        catalyst.setText(CATALYST_S);
        ...
        ename01	.setText(enablerNameArray[0]);	elevel01	.setText(lv+enablerLvArray[0]);	epower01	.setText("");
        ename02	.setText(enablerNameArray[1]);	elevel02	.setText(lv+enablerLvArray[1]);	epower02	.setText("");
        ename03	.setText(enablerNameArray[2]);	elevel03	.setText(lv+enablerLvArray[2]);	epower03	.setText("");
        ename04	.setText(enablerNameArray[3]);	elevel04	.setText(lv+enablerLvArray[3]);	epower04	.setText("");
        ename05	.setText(enablerNameArray[4]);	elevel05	.setText(lv+enablerLvArray[4]);	epower05	.setText("");
        ename06	.setText(enablerNameArray[5]);	elevel06	.setText(lv+enablerLvArray[5]);	epower06	.setText("");
        ename07	.setText(enablerNameArray[6]);	elevel07	.setText(lv+enablerLvArray[6]);	epower07	.setText("");
        ename08	.setText(enablerNameArray[7]);	elevel08	.setText(lv+enablerLvArray[7]);	epower08	.setText("");
        ename09	.setText(enablerNameArray[8]);	elevel09	.setText(lv+enablerLvArray[8]);	epower09	.setText("");
        ename10	.setText(enablerNameArray[9]);	elevel10	.setText(lv+enablerLvArray[9]);	epower10	.setText("");
        ename11	.setText(enablerNameArray[10]);	elevel11	.setText(lv+enablerLvArray[10]);	epower11	.setText("");
        ename12	.setText(enablerNameArray[11]);	elevel12	.setText(lv+enablerLvArray[11]);	epower12	.setText("");
        ename13	.setText(enablerNameArray[12]);	elevel13	.setText(lv+enablerLvArray[12]);	epower13	.setText("");
        ename14	.setText(enablerNameArray[13]);	elevel14	.setText(lv+enablerLvArray[13]);	epower14	.setText("");
        ename15	.setText(enablerNameArray[14]);	elevel15	.setText(lv+enablerLvArray[14]);	epower15	.setText("");
        ename16	.setText(enablerNameArray[15]);	elevel16	.setText(lv+enablerLvArray[15]);	epower16	.setText("");
        ename17	.setText(enablerNameArray[16]);	elevel17	.setText(lv+enablerLvArray[16]);	epower17	.setText("");
        ename18	.setText(enablerNameArray[17]);	elevel18	.setText(lv+enablerLvArray[17]);	epower18	.setText("");
        ename19	.setText(enablerNameArray[18]);	elevel19	.setText(lv+enablerLvArray[18]);	epower19	.setText("");
        ename20	.setText(enablerNameArray[19]);	elevel20	.setText(lv+enablerLvArray[19]);	epower20	.setText("");
        ename21	.setText(enablerNameArray[20]);	elevel21	.setText(lv+enablerLvArray[20]);	epower21	.setText("");
        ename22	.setText(enablerNameArray[21]);	elevel22	.setText(lv+enablerLvArray[21]);	epower22	.setText("");
        ename23	.setText(enablerNameArray[22]);	elevel23	.setText(lv+enablerLvArray[22]);	epower23	.setText("");
        ename24	.setText(enablerNameArray[23]);	elevel24	.setText(lv+enablerLvArray[23]);	epower24	.setText("");
        ename25	.setText(enablerNameArray[24]);	elevel25	.setText(lv+enablerLvArray[24]);	epower25	.setText("");
        ename26	.setText(enablerNameArray[25]);	elevel26	.setText(lv+enablerLvArray[25]);	epower26	.setText("");
        ename27	.setText(enablerNameArray[26]);	elevel27	.setText(lv+enablerLvArray[26]);	epower27	.setText("");
        ename28	.setText(enablerNameArray[27]);	elevel28	.setText(lv+enablerLvArray[27]);	epower28	.setText("");
        ename29	.setText(enablerNameArray[28]);	elevel29	.setText(lv+enablerLvArray[28]);	epower29	.setText("");
        ename30	.setText(enablerNameArray[29]);	elevel30	.setText(lv+enablerLvArray[29]);	epower30	.setText("");
        ename31	.setText(enablerNameArray[30]);	elevel31	.setText(lv+enablerLvArray[30]);	epower31	.setText("");
        ename32	.setText(enablerNameArray[31]);	elevel32	.setText(lv+enablerLvArray[31]);	epower32	.setText("");
        ename33	.setText(enablerNameArray[32]);	elevel33	.setText(lv+enablerLvArray[32]);	epower33	.setText("");
        ename34	.setText(enablerNameArray[33]);	elevel34	.setText(lv+enablerLvArray[33]);	epower34	.setText("");
        ename35	.setText(enablerNameArray[34]);	elevel35	.setText(lv+enablerLvArray[34]);	epower35	.setText("");
        ename36	.setText(enablerNameArray[35]);	elevel36	.setText(lv+enablerLvArray[35]);	epower36	.setText("");
        ename37	.setText(enablerNameArray[36]);	elevel37	.setText(lv+enablerLvArray[36]);	epower37	.setText("");
        ename38	.setText(enablerNameArray[37]);	elevel38	.setText(lv+enablerLvArray[37]);	epower38	.setText("");
        ename39	.setText(enablerNameArray[38]);	elevel39	.setText(lv+enablerLvArray[38]);	epower39	.setText("");
        ename40	.setText(enablerNameArray[39]);	elevel40	.setText(lv+enablerLvArray[39]);	epower40	.setText("");
        ename41	.setText(enablerNameArray[40]);	elevel41	.setText(lv+enablerLvArray[40]);	epower41	.setText("");
        ename42	.setText(enablerNameArray[41]);	elevel42	.setText(lv+enablerLvArray[41]);	epower42	.setText("");
        ename43	.setText(enablerNameArray[42]);	elevel43	.setText(lv+enablerLvArray[42]);	epower43	.setText("");
        ename44	.setText(enablerNameArray[43]);	elevel44	.setText(lv+enablerLvArray[43]);	epower44	.setText("");
        ename45	.setText(enablerNameArray[44]);	elevel45	.setText(lv+enablerLvArray[44]);	epower45	.setText("");
        ename46	.setText(enablerNameArray[45]);	elevel46	.setText(lv+enablerLvArray[45]);	epower46	.setText("");
        ename47	.setText(enablerNameArray[46]);	elevel47	.setText(lv+enablerLvArray[46]);	epower47	.setText("");
        ename48	.setText(enablerNameArray[47]);	elevel48	.setText(lv+enablerLvArray[47]);	epower48	.setText("");

        if (enablerLvArray[0] 	 == 0 ) {	elevel01	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[0] 	 == 1 ) {	elevel01	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[0] 	 == 2 ) {	elevel01	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[0] 	 == 3 ) {	elevel01	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[0] 	 == 4 ) {	elevel01	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[1]	 == 0 ) {	elevel02	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[1]	 == 1 ) {	elevel02	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[1]	 == 2 ) {	elevel02	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[1]	 == 3 ) {	elevel02	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[1]	 == 4 ) {	elevel02	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[2]	 == 0 ) {	elevel03	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[2]	 == 1 ) {	elevel03	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[2]	 == 2 ) {	elevel03	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[2]	 == 3 ) {	elevel03	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[2]	 == 4 ) {	elevel03	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[3]	 == 0 ) {	elevel04	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[3]	 == 1 ) {	elevel04	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[3]	 == 2 ) {	elevel04	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[3]	 == 3 ) {	elevel04	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[3]	 == 4 ) {	elevel04	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[4]	 == 0 ) {	elevel05	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[4]	 == 1 ) {	elevel05	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[4]	 == 2 ) {	elevel05	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[4]	 == 3 ) {	elevel05	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[4]	 == 4 ) {	elevel05	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[5]	 == 0 ) {	elevel06	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[5]	 == 1 ) {	elevel06	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[5]	 == 2 ) {	elevel06	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[5]	 == 3 ) {	elevel06	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[5]	 == 4 ) {	elevel06	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[6]	 == 0 ) {	elevel07	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[6]	 == 1 ) {	elevel07	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[6]	 == 2 ) {	elevel07	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[6]	 == 3 ) {	elevel07	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[6]	 == 4 ) {	elevel07	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[7]	 == 0 ) {	elevel08	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[7]	 == 1 ) {	elevel08	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[7]	 == 2 ) {	elevel08	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[7]	 == 3 ) {	elevel08	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[7]	 == 4 ) {	elevel08	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[8]	 == 0 ) {	elevel09	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[8]	 == 1 ) {	elevel09	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[8]	 == 2 ) {	elevel09	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[8]	 == 3 ) {	elevel09	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[8]	 == 4 ) {	elevel09	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[9]	 == 0 ) {	elevel10	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[9]	 == 1 ) {	elevel10	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[9]	 == 2 ) {	elevel10	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[9]	 == 3 ) {	elevel10	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[9]	 == 4 ) {	elevel10	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[10]	 == 0 ) {	elevel11	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[10]	 == 1 ) {	elevel11	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[10]	 == 2 ) {	elevel11	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[10]	 == 3 ) {	elevel11	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[10]	 == 4 ) {	elevel11	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[11]	 == 0 ) {	elevel12	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[11]	 == 1 ) {	elevel12	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[11]	 == 2 ) {	elevel12	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[11]	 == 3 ) {	elevel12	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[11]	 == 4 ) {	elevel12	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[12]	 == 0 ) {	elevel13	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[12]	 == 1 ) {	elevel13	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[12]	 == 2 ) {	elevel13	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[12]	 == 3 ) {	elevel13	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[12]	 == 4 ) {	elevel13	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[13]	 == 0 ) {	elevel14	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[13]	 == 1 ) {	elevel14	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[13]	 == 2 ) {	elevel14	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[13]	 == 3 ) {	elevel14	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[13]	 == 4 ) {	elevel14	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[14]	 == 0 ) {	elevel15	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[14]	 == 1 ) {	elevel15	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[14]	 == 2 ) {	elevel15	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[14]	 == 3 ) {	elevel15	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[14]	 == 4 ) {	elevel15	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[15]	 == 0 ) {	elevel16	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[15]	 == 1 ) {	elevel16	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[15]	 == 2 ) {	elevel16	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[15]	 == 3 ) {	elevel16	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[15]	 == 4 ) {	elevel16	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[16]	 == 0 ) {	elevel17	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[16]	 == 1 ) {	elevel17	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[16]	 == 2 ) {	elevel17	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[16]	 == 3 ) {	elevel17	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[16]	 == 4 ) {	elevel17	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[17]	 == 0 ) {	elevel18	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[17]	 == 1 ) {	elevel18	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[17]	 == 2 ) {	elevel18	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[17]	 == 3 ) {	elevel18	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[17]	 == 4 ) {	elevel18	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[18]	 == 0 ) {	elevel19	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[18]	 == 1 ) {	elevel19	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[18]	 == 2 ) {	elevel19	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[18]	 == 3 ) {	elevel19	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[18]	 == 4 ) {	elevel19	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[19]	 == 0 ) {	elevel20	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[19]	 == 1 ) {	elevel20	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[19]	 == 2 ) {	elevel20	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[19]	 == 3 ) {	elevel20	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[19]	 == 4 ) {	elevel20	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[20]	 == 0 ) {	elevel21	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[20]	 == 1 ) {	elevel21	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[20]	 == 2 ) {	elevel21	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[20]	 == 3 ) {	elevel21	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[20]	 == 4 ) {	elevel21	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[21]	 == 0 ) {	elevel22	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[21]	 == 1 ) {	elevel22	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[21]	 == 2 ) {	elevel22	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[21]	 == 3 ) {	elevel22	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[21]	 == 4 ) {	elevel22	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[22]	 == 0 ) {	elevel23	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[22]	 == 1 ) {	elevel23	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[22]	 == 2 ) {	elevel23	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[22]	 == 3 ) {	elevel23	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[22]	 == 4 ) {	elevel23	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[23]	 == 0 ) {	elevel24	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[23]	 == 1 ) {	elevel24	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[23]	 == 2 ) {	elevel24	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[23]	 == 3 ) {	elevel24	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[23]	 == 4 ) {	elevel24	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[24]	 == 0 ) {	elevel25	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[24]	 == 1 ) {	elevel25	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[24]	 == 2 ) {	elevel25	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[24]	 == 3 ) {	elevel25	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[24]	 == 4 ) {	elevel25	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[25]	 == 0 ) {	elevel26	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[25]	 == 1 ) {	elevel26	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[25]	 == 2 ) {	elevel26	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[25]	 == 3 ) {	elevel26	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[25]	 == 4 ) {	elevel26	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[26]	 == 0 ) {	elevel27	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[26]	 == 1 ) {	elevel27	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[26]	 == 2 ) {	elevel27	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[26]	 == 3 ) {	elevel27	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[26]	 == 4 ) {	elevel27	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[27]	 == 0 ) {	elevel28	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[27]	 == 1 ) {	elevel28	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[27]	 == 2 ) {	elevel28	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[27]	 == 3 ) {	elevel28	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[27]	 == 4 ) {	elevel28	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[28]	 == 0 ) {	elevel29	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[28]	 == 1 ) {	elevel29	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[28]	 == 2 ) {	elevel29	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[28]	 == 3 ) {	elevel29	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[28]	 == 4 ) {	elevel29	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[29]	 == 0 ) {	elevel30	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[29]	 == 1 ) {	elevel30	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[29]	 == 2 ) {	elevel30	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[29]	 == 3 ) {	elevel30	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[29]	 == 4 ) {	elevel30	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[30]	 == 0 ) {	elevel31	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[30]	 == 1 ) {	elevel31	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[30]	 == 2 ) {	elevel31	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[30]	 == 3 ) {	elevel31	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[30]	 == 4 ) {	elevel31	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[31]	 == 0 ) {	elevel32	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[31]	 == 1 ) {	elevel32	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[31]	 == 2 ) {	elevel32	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[31]	 == 3 ) {	elevel32	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[31]	 == 4 ) {	elevel32	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[32]	 == 0 ) {	elevel33	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[32]	 == 1 ) {	elevel33	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[32]	 == 2 ) {	elevel33	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[32]	 == 3 ) {	elevel33	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[32]	 == 4 ) {	elevel33	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[33]	 == 0 ) {	elevel34	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[33]	 == 1 ) {	elevel34	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[33]	 == 2 ) {	elevel34	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[33]	 == 3 ) {	elevel34	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[33]	 == 4 ) {	elevel34	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[34]	 == 0 ) {	elevel35	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[34]	 == 1 ) {	elevel35	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[34]	 == 2 ) {	elevel35	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[34]	 == 3 ) {	elevel35	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[34]	 == 4 ) {	elevel35	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[35]	 == 0 ) {	elevel36	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[35]	 == 1 ) {	elevel36	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[35]	 == 2 ) {	elevel36	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[35]	 == 3 ) {	elevel36	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[35]	 == 4 ) {	elevel36	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[36]	 == 0 ) {	elevel37	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[36]	 == 1 ) {	elevel37	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[36]	 == 2 ) {	elevel37	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[36]	 == 3 ) {	elevel37	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[36]	 == 4 ) {	elevel37	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[37]	 == 0 ) {	elevel38	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[37]	 == 1 ) {	elevel38	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[37]	 == 2 ) {	elevel38	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[37]	 == 3 ) {	elevel38	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[37]	 == 4 ) {	elevel38	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[38]	 == 0 ) {	elevel39	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[38]	 == 1 ) {	elevel39	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[38]	 == 2 ) {	elevel39	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[38]	 == 3 ) {	elevel39	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[38]	 == 4 ) {	elevel39	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[39]	 == 0 ) {	elevel40	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[39]	 == 1 ) {	elevel40	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[39]	 == 2 ) {	elevel40	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[39]	 == 3 ) {	elevel40	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[39]	 == 4 ) {	elevel40	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[40]	 == 0 ) {	elevel41	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[40]	 == 1 ) {	elevel41	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[40]	 == 2 ) {	elevel41	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[40]	 == 3 ) {	elevel41	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[40]	 == 4 ) {	elevel41	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[41]	 == 0 ) {	elevel42	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[41]	 == 1 ) {	elevel42	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[41]	 == 2 ) {	elevel42	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[41]	 == 3 ) {	elevel42	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[41]	 == 4 ) {	elevel42	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[42]	 == 0 ) {	elevel43	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[42]	 == 1 ) {	elevel43	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[42]	 == 2 ) {	elevel43	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[42]	 == 3 ) {	elevel43	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[42]	 == 4 ) {	elevel43	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[43]	 == 0 ) {	elevel44	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[43]	 == 1 ) {	elevel44	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[43]	 == 2 ) {	elevel44	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[43]	 == 3 ) {	elevel44	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[43]	 == 4 ) {	elevel44	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[44]	 == 0 ) {	elevel45	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[44]	 == 1 ) {	elevel45	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[44]	 == 2 ) {	elevel45	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[44]	 == 3 ) {	elevel45	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[44]	 == 4 ) {	elevel45	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[45]	 == 0 ) {	elevel46	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[45]	 == 1 ) {	elevel46	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[45]	 == 2 ) {	elevel46	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[45]	 == 3 ) {	elevel46	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[45]	 == 4 ) {	elevel46	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[46]	 == 0 ) {	elevel47	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[46]	 == 1 ) {	elevel47	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[46]	 == 2 ) {	elevel47	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[46]	 == 3 ) {	elevel47	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[46]	 == 4 ) {	elevel47	.setText(getString(R.string.enabler_s05));}
        if (enablerLvArray[47]	 == 0 ) {	elevel48	.setText(getString(R.string.enabler_s01));}	if (enablerLvArray[47]	 == 1 ) {	elevel48	.setText(getString(R.string.enabler_s02));}	if (enablerLvArray[47]	 == 2 ) {	elevel48	.setText(getString(R.string.enabler_s03));}	if (enablerLvArray[47]	 == 3 ) {	elevel48	.setText(getString(R.string.enabler_s04));}	if (enablerLvArray[47]	 == 4 ) {	elevel48	.setText(getString(R.string.enabler_s05));}
        ...
        if (!show){
            if(T_TEMP01	.equals("0")){	arm01	.setVisibility(View.INVISIBLE);	arm01_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP02	.equals("0")){	mili01	.setVisibility(View.INVISIBLE);	mili01_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP03	.equals("0")){	mobile01	.setVisibility(View.INVISIBLE);	mobile01_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP04	.equals("0")){	infect01	.setVisibility(View.INVISIBLE);	infect01_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP05	.equals("0")){	project01	.setVisibility(View.INVISIBLE);	project01_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP06	.equals("0")){	arm02	.setVisibility(View.INVISIBLE);	arm02_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP07	.equals("0")){	mili02	.setVisibility(View.INVISIBLE);	mili02_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP08	.equals("0")){	mobile02	.setVisibility(View.INVISIBLE);	mobile02_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP09	.equals("0")){	infect02	.setVisibility(View.INVISIBLE);	infect02_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP10	.equals("0")){	project02	.setVisibility(View.INVISIBLE);	project02_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP11	.equals("0")){	arm03	.setVisibility(View.INVISIBLE);	arm03_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP12	.equals("0")){	mili03	.setVisibility(View.INVISIBLE);	mili03_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP13	.equals("0")){	mobile03	.setVisibility(View.INVISIBLE);	mobile03_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP14	.equals("0")){	infect03	.setVisibility(View.INVISIBLE);	infect03_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP15	.equals("0")){	project03	.setVisibility(View.INVISIBLE);	project03_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP16	.equals("0")){	arm04	.setVisibility(View.INVISIBLE);	arm04_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP17	.equals("0")){	mili04	.setVisibility(View.INVISIBLE);	mili04_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP18	.equals("0")){	mobile04	.setVisibility(View.INVISIBLE);	mobile04_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP19	.equals("0")){	infect04	.setVisibility(View.INVISIBLE);	infect04_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP20	.equals("0")){	project04	.setVisibility(View.INVISIBLE);	project04_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP21	.equals("0")){	arm05	.setVisibility(View.INVISIBLE);	arm05_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP22	.equals("0")){	mili05	.setVisibility(View.INVISIBLE);	mili05_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP23	.equals("0")){	mobile05	.setVisibility(View.INVISIBLE);	mobile05_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP24	.equals("0")){	infect05	.setVisibility(View.INVISIBLE);	infect05_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP25	.equals("0")){	project05	.setVisibility(View.INVISIBLE);	project05_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP26	.equals("0")){	arm06	.setVisibility(View.INVISIBLE);	arm06_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP27	.equals("0")){	mili06	.setVisibility(View.INVISIBLE);	mili06_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP28	.equals("0")){	mobile06	.setVisibility(View.INVISIBLE);	mobile06_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP29	.equals("0")){	infect06	.setVisibility(View.INVISIBLE);	infect06_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP30	.equals("0")){	project06	.setVisibility(View.INVISIBLE);	project06_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP31	.equals("0")){	arm07	.setVisibility(View.INVISIBLE);	arm07_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP32	.equals("0")){	mili07	.setVisibility(View.INVISIBLE);	mili07_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP33	.equals("0")){	mobile07	.setVisibility(View.INVISIBLE);	mobile07_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP34	.equals("0")){	infect07	.setVisibility(View.INVISIBLE);	infect07_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP35	.equals("0")){	project07	.setVisibility(View.INVISIBLE);	project07_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP36	.equals("0")){	arm08	.setVisibility(View.INVISIBLE);	arm08_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP37	.equals("0")){	mili08	.setVisibility(View.INVISIBLE);	mili08_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP38	.equals("0")){	mobile08	.setVisibility(View.INVISIBLE);	mobile08_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP39	.equals("0")){	infect08	.setVisibility(View.INVISIBLE);	infect08_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP40	.equals("0")){	project08	.setVisibility(View.INVISIBLE);	project08_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP41	.equals("0")){	arm09	.setVisibility(View.INVISIBLE);	arm09_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP42	.equals("0")){	mili09	.setVisibility(View.INVISIBLE);	mili09_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP43	.equals("0")){	mobile09	.setVisibility(View.INVISIBLE);	mobile09_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP44	.equals("0")){	infect09	.setVisibility(View.INVISIBLE);	infect09_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP45	.equals("0")){	project09	.setVisibility(View.INVISIBLE);	project09_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP46	.equals("0")){	arm10	.setVisibility(View.INVISIBLE);	arm10_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP47	.equals("0")){	mili10	.setVisibility(View.INVISIBLE);	mili10_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP48	.equals("0")){	mobile10	.setVisibility(View.INVISIBLE);	mobile10_img	.setVisibility(View.INVISIBLE);	}
            if(T_TEMP49	.equals("0")){	infect10	.setVisibility(View.INVISIBLE);	infect10_img	.setVisibility(View.INVISIBLE);	}
        ...
        arm01	.setText(	T_TEMP01	);
        mili01	.setText(	T_TEMP02	);
        mobile01	.setText(	T_TEMP03	);
        infect01	.setText(	T_TEMP04	);
        project01	.setText(	T_TEMP05	);
        arm02	.setText(	T_TEMP06	);
        mili02	.setText(	T_TEMP07	);
        mobile02	.setText(	T_TEMP08	);
        infect02	.setText(	T_TEMP09	);
        project02	.setText(	T_TEMP10	);
        arm03	.setText(	T_TEMP11	);
        mili03	.setText(	T_TEMP12	);
        mobile03	.setText(	T_TEMP13	);
        infect03	.setText(	T_TEMP14	);
        project03	.setText(	T_TEMP15	);
        arm04	.setText(	T_TEMP16	);
        mili04	.setText(	T_TEMP17	);
        mobile04	.setText(	T_TEMP18	);
        infect04	.setText(	T_TEMP19	);
        project04	.setText(	T_TEMP20	);
        arm05	.setText(	T_TEMP21	);
        mili05	.setText(	T_TEMP22	);
        mobile05	.setText(	T_TEMP23	);
        infect05	.setText(	T_TEMP24	);
        project05	.setText(	T_TEMP25	);
        arm06	.setText(	T_TEMP26	);
        mili06	.setText(	T_TEMP27	);
        mobile06	.setText(	T_TEMP28	);
        infect06	.setText(	T_TEMP29	);
        project06	.setText(	T_TEMP30	);
        arm07	.setText(	T_TEMP31	);
        mili07	.setText(	T_TEMP32	);
        mobile07	.setText(	T_TEMP33	);
        infect07	.setText(	T_TEMP34	);
        project07	.setText(	T_TEMP35	);
        arm08	.setText(	T_TEMP36	);
        mili08	.setText(	T_TEMP37	);
        mobile08	.setText(	T_TEMP38	);
        infect08	.setText(	T_TEMP39	);
        project08	.setText(	T_TEMP40	);
        arm09	.setText(	T_TEMP41	);
        mili09	.setText(	T_TEMP42	);
        mobile09	.setText(	T_TEMP43	);
        infect09	.setText(	T_TEMP44	);
        project09	.setText(	T_TEMP45	);
        arm10	.setText(	T_TEMP46	);
        mili10	.setText(	T_TEMP47	);
        mobile10	.setText(	T_TEMP48	);
        infect10	.setText(	T_TEMP49	);
    ...
    private class TakeData extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (input_json_list == true){url = "http://p1.xingjoys.net:8081/gameservice/externalAccessData.php?uid="+UID;} else {url = "http://vt.25u.com/vt/zgt/demo_user.json";}
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < rss.length(); i++) {
                        ...
                        glory_mark_final = rss.getInt("chip");
                        catalyst_final = rss.getInt("scientificStone");
                        diamond_final = rss.getInt("chip");
